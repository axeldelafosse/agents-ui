...
// biome-ignore lint/performance/noNamespaceImport: Shadcn generated component
...
// biome-ignore lint/style/useConsistentTypeDefinitions: Shadcn generated component
...
function SidebarProvider({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: Shadcn generated component
...
function Sidebar({
  ...
  const shouldExpandSidebar = (
    ...
    const isInteractive = Boolean(
      closestInteractiveElement && closestInteractiveElement !== fallbackTarget
    )
  ...
  const handleSidebarClick = (event: React.MouseEvent) => {
    shouldExpandSidebar(event.target, event.currentTarget)
  }
  ...
  if (collapsible === "none") {
    return (
      <div
        className={cn(
          "liquid-sidebar flex h-full w-(--sidebar-width) flex-col text-sidebar-foreground",
          className
        )}
        data-slot="sidebar"
        {...props}
  ...
  if (isMobile) {
    return (
      <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
        <SheetContent
          className="liquid-sidebar w-(--sidebar-width) p-0 text-sidebar-foreground [&>button]:hidden"
          data-mobile="true"
          data-side={side}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="liquid-sidebar flex size-full flex-col transition-[border-radius] duration-100 ease-in-out group-data-[state=collapsed]:group-data-[variant=floating]:rounded-3xl group-data-[state=collapsed]:cursor-pointer group-data-[variant=floating]:rounded-3xl group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
          data-sidebar="sidebar"
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
